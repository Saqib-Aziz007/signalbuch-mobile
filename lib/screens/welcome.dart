              ...
              Row(
                ...
                children: [
                  Text('X (Twitter): ',
                      style: Theme.of(context).textTheme.bodyMedium),
                  GestureDetector(
                    onTap: () => {}, // Add X link handler
                    child: Text('@signalbuch',
              ...
              Row(
                ...
                children: [
                  Text('YouTube: ',
                      style: Theme.of(context).textTheme.bodyMedium),
                  GestureDetector(
                    onTap: () => {}, // Add YouTube link handler
                    child: Text('@hdi-bahndienstleistungen',
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                            color: Theme.of(context).primaryColor,
                            fontWeight: FontWeight.bold)),
                  ),
              ...
              Row(
                ...
                children: [
                  Text('Instagram: ',
                      style: Theme.of(context).textTheme.bodyMedium),
                  GestureDetector(
                    onTap: () => {}, // Add Instagram link handler
                    child: Text('staatsberater',
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                            color: Theme.of(context).primaryColor,
                            fontWeight: FontWeight.bold)),
                  ),
